...
`;var jn=Object.defineProperty,Fn=Object.getOwnPropertyDescriptor,Br=(e,t,r,o)=>{for(var n=o>1?void 0:o?Fn(t,r):t,i=e.length-1,s;i>=0;i--)(s=e[i])&&(n=(o?s(t,r,n):s(n))||n);return o&&n&&jn(t,r,n),n};let Zt=class extends R{constructor(){super();this.message="Welcome!"}static get styles(){return[In,At`
    ...
    `}render(){return rt`
      <header>
        ...
        <div id="back-button-block">
          ${this.enableBack?rt`<sl-button href="${"/SafetTest/"}">
            Back
          </sl-button>`:null}
    ...
    `}constructor(){super()}firstUpdated(){var t;new P((t=this.shadowRoot)==null?void 0:t.querySelector("#routerOutlet")).setRoutes([{path:"/SafetTest/",animate:!0,children:[{path:"",component:"app-home"},{path:"about",component:"app-about",action:async()=>{await Qr(()=>import("./app-about.69c0cdcc.js"),[])}}]}])}render(){return rt`
      <div>
        <main>
...
//# sourceMappingURL=index.ae14531a.js.map
